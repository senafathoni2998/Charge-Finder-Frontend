...
describe('SignupFormCard', () => {
    ...
    it('should render the subtitle', () => {
        render(<SignupFormCard {...defaultProps} />);
        expect(screen.getByText('Save your car profile and personalize stations.')).toBeInTheDocument();
    });
    ...
    it('should render the terms text', () => {
        render(<SignupFormCard {...defaultProps} />);
        expect(screen.getByText('By creating an account, you agree to the demo Terms and Privacy.')).toBeInTheDocument();
    });

    it('should call onNameChange when name field changes', () => {
        const onNameChange = vi.fn();
        render(<SignupFormCard {...defaultProps} handlers={{ ...defaultProps.handlers, onNameChange }} />);
    ...
    it('should call onRegionChange when region field changes', () => {
        ...
        render(<SignupFormCard {...defaultProps} handlers={{ ...defaultProps.handlers, onRegionChange }} />);
    ...
    it('should call onEmailChange when email field changes', () => {
        ...
        render(<SignupFormCard {...defaultProps} handlers={{ ...defaultProps.handlers, onEmailChange }} />);
    ...
    it('should call onPasswordChange when password field changes', () => {
        ...
        render(<SignupFormCard {...defaultProps} handlers={{ ...defaultProps.handlers, onPasswordChange }} />);
    ...
    it('should call onConfirmChange when confirm password field changes', () => {
        ...
        render(<SignupFormCard {...defaultProps} handlers={{ ...defaultProps.handlers, onConfirmChange }} />);
    ...
    it('should call onNavigateToLogin when Sign in link is clicked', () => {
        ...
        render(<SignupFormCard {...defaultProps} onNavigateToLogin={onNavigateToLogin} />);
    ...
    it('should call onDismissError when alert close button is clicked', () => {
        ...
        render(<SignupFormCard {...defaultProps} error="Test error" onDismissError={onDismissError} />);
    ...
    it('should toggle password visibility when eye icon is clicked', () => {
        ...
        const eyeButton = toggleButtons.find((button) =>
            button.querySelector('svg')?.getAttribute('data-testid')?.includes('Visibility')
        );
