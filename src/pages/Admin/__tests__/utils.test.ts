...
describe('Admin utils', () => {
    describe('normalizeAdminUser', () => {
        it('should return null for invalid input', () => {
            ...
            expect(normalizeAdminUser(123)).toBeNull();
            expect(normalizeAdminUser({})).toBeNull(); // No ID
        });
        ...
        it('should normalize valid user data', () => {
            ...
            const result = normalizeAdminUser(input);
    ...
    describe('userActionLabel', () => {
        it('should return correct label', () => {
            expect(userActionLabel('active')).toBe('Suspend');
            expect(userActionLabel('suspended')).toBe('Activate');
            expect(userActionLabel('pending')).toBe('Approve');
        });
    });
